...
export function BentoGallery() {
  return (
    <section id="asi-somos" className="mx-auto max-w-6xl px-4 py-14 md:px-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2 lg:items-start">
        <div className="overflow-hidden rounded-3xl border border-mkt-border bg-mkt-card shadow-md">
          <div className="relative aspect-square w-full sm:aspect-[5/4]">
            <Image
              src="/marketing/collage-promo.png"
              alt="Collage: camas, fachada y promoción Dormitorios Plaza Basílica"
              fill
