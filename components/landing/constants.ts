...
export const MAP_SEARCH_HREF =
  ...
  encodeURIComponent("Arica 91, Tepeyac Insurgentes, Gustavo A. Madero, Ciudad de México");
export const NIGHTLY_PRICE_MXN = 120;
export const METRO_COPY = "Cerca de la estación Metrobús Deportivo 18 de marzo";
