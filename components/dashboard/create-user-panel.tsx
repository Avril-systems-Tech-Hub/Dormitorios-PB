...
export function CreateUserPanel({ roles }: CreateUserPanelProps) {
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm text-text-muted">
            {open
              ? "Crea una cuenta de recepción u otro rol personalizado. No se puede crear otro administrador."
        ...
        <form action={createSystemUserAction} className="mt-4 space-y-3 rounded-xl border border-border-soft bg-white p-4">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div>
              ...
              <select id="new-user-role" name="role_id" required className={cn(fieldClass, "capitalize")}>
